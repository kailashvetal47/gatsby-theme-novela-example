...
# Deploying a Gatsby Site to Firebase with Google Cloud Build (CI/CD) - DEV Community 👩‍💻👨‍💻
...
![Deploying%20a%20Gatsby%20Site%20to%20Firebase%20with%20Google%20Cl/giphy.gif](Deploying%20a%20Gatsby%20Site%20to%20Firebase%20with%20Google%20Cl/giphy.gif)